...
final class AllSupport extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('category')
            ->addColumn('message')
            ->addColumn('solved_format', function (Support $model) {
                return $model->solved ? "Solved" : "Pending";
            })
    ...
    public function actions(): array
    {
        return [
            ...
            Button::make('detail', 'Detail')
                ...
                ->target("")
                ->route("user.support.show", ["support" => "id"])
        ];
    }
