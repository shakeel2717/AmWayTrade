...
namespace App\Http\Livewire\user\indirect;
...
final class Level2 extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    ...
    {
        return User::query()->whereIn('id', levelSecondRefers(auth()->user()->id));
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('phone')
            ->addColumn('country')
            ->addColumn('status_format', function (User $model) {
                return $model->status ? "Active" : "Pending";
            })
