...
final class AllLotteries extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('CONTEST ID', 'contest_id')
                ->makeInputRange(),
