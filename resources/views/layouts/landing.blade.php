                    ...
                    <div class="slider-content">
                        <div class="slide-caption medium">
                            <div class="inner-layer">
                                <div data-animation="fade-in-right" data-delay="1s">Think In Motion</div>
                            </div>
                        </div>
                        <div class="slide-caption big">
                            <div class="inner-layer">
                                <div data-animation="reveal-text" data-delay="1s"><span
                                        style="animation-delay: 1s;"></span>Take Your Investment TO</div>
                            </div>
                        </div>
                        <div class="slide-caption big">
                            <div class="inner-layer">
                                <div data-animation="reveal-text" data-delay="2s"><span
                                        style="animation-delay: 2s;"></span>The Next Level.</div>
                            </div>
                        </div>
                        ...
                        <div class="slide-btn-group">
                            <div class="inner-layer">
                                <a href="{{ route('register') }}" class="slide-btn" data-animation="fade-in-bottom"
                                    data-delay="3.5s">Get Started Today</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 wow fadeInLeft" data-wow-delay="200ms">
                    <div class="section-heading">
                        ...
                        <p>{{ env('APP_NAME') }} a trusted name for providing assistants. Initially their main
                ...
                <div class="col-md-6 wow fadeInRight" data-wow-delay="200ms">
                    <div class="about-bg-holder">
                        ...
                        <a class="play-btn venobox" data-vbtype="video"
                            ...
                            <span class="play-icon"><svg aria-hidden="true" focusable="false" role="img"
            ...
            <div class="row service-items">
                <div class="col-lg-3 col-sm-6 sm-padding wow fadeInUp" data-wow-delay="200ms">
                    <div class="service-item">
                        ...
                        <a href="{{ route('register') }}" class="read-more">Read More<i
    ...
    <section class="counter-section padding">
        ...
        <div class="container">
            <div class="section-heading text-center">
                ...
                <a href="{{ route('user.support.create') }}" class="default-btn wow fadeInUp"
                    data-wow-delay="500ms">Talk with Support Agent</a>
            </div>
            ...
            <div class="container">
                <div class="footer-info-inner">
                    <div class="footer-info-list">
                        <div><svg enable-background="new 0 0 512.076 512.076" version="1.1"
                                viewBox="0 0 512.08 512.08" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="footer-info-list">
                        <div><svg enable-background="new 0 0 511.991 511.991" version="1.1"
                                viewBox="0 0 511.99 511.99" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="footer-info-list">
                        <div><svg enable-background="new 0 0 511.998 511.998" version="1.1" viewBox="0 0 512 512"
                        ...
                        <div class="footer-widget link-widget">
                            ...
                            <ul class="widget-links">
                                ...
                                <li><i class="fas fa-square-full"></i><a
                                        href="{{ route('user.support.index') }}">Support</a></li>
                                <li><i class="fas fa-square-full"></i><a
                                        href="{{ route('user.plans.index') }}">Pricing</a></li>
                            </ul>
